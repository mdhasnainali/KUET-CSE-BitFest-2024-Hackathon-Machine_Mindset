...
SECRET_KEY = "django-insecure-=fk=sw4x*=4x+l-s4$*w1z_og***j#^-26^3mt%-05at_wx9ib"
...
# )
# ACCOUNT_PASSWORD_RESET_HTML_TEMPLATE = "account/email/password_reset_key_message.html"
...
STATIC_URL = "/static/"
STATIC_ROOT = os.path.join(BASE_DIR, "static")  # Directory to collect static files
